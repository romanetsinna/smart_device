...
var boxes = Array.from(document.querySelectorAll('.accordion__box'));
...
function boxHandler(e) {
  hidePanels();
  e.preventDefault();
  var currentBox = e.target.closest('.accordion__box');
...
function hidePanels() {
  var acc = document.querySelectorAll('.accordion__box');
  var accPanel = document.querySelectorAll('.accordion__content');
...
var moreText = document.querySelector('.about__show-more');
var btnText = document.querySelector('.about__button');
